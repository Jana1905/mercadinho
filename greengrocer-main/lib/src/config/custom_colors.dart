...
Map<int, Color> _swatchOpacity = { // _para não acessar fora do arquivo
  50: const Color.fromRGBO(139, 195, 74, .1), // pesquisa no google color picker
...
abstract class CustomColors {
  static Color customContrastColor = Colors.red.shade700; //(tonalidade de cor do vermelho)
